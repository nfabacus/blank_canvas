...
ActiveRecord::Schema.define(version: 20160914153816) do
  ...
  add_index "sketches", ["canva_id"], name: "index_sketches_on_canva_id", using: :btree
  ...
  add_foreign_key "sketches", "canvas"
end
